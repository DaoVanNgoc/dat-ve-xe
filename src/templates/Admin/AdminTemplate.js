						...
						<Layout style={{minHeight: "100vh"}}>
							<Sider collapsible collapsed={collapsed} onCollapse={changeCollapsed}>
								<div className="logo flex justify-center items-center mt-5">
									<img src="./images/logovexe.jpg" alt={123} className="mb-5" style={{width: "100px", height: "50px", paddingTop: "20px"}} />
								</div>
							...
							<Layout className="site-layout">
								...
								<Footer style={{textAlign: "center"}}>Created 2024 by NQC</Footer>
							</Layout>
						</Layout>
					</Fragment>
				);
